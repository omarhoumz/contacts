...
| R5  | P1       | IN_PROGRESS  | code+design | R2,R3,R4   | Rewrite primary UI layout and visual system baseline using Tailwind + shadcn patterns where applicable (web-first).              | Web uses consistent spacing/typography/states across auth, labels, contacts, trash; no regressions in core tasks; design tokens documented.                                                                                         |
