...
| A4 | P0 | IN_PROGRESS | command+code | A3 | Run `pnpm build`; fix Vite/Storybook/build script failures until green. | Pending. |
| A5 | P0 | TODO | command/external | A4 | Confirm `.github/workflows/ci.yml` passes on PR/branch. | CI run URL or check summary. |
