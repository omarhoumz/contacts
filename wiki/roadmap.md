...
| B3  | P1       | DONE        | code/docs        | B2         | Align `apps/backend/supabase/config.toml` `project_id`.                    | `project_id` set to `issiwryobnohfevlzyuu` in `apps/backend/supabase/config.toml`.                            |
