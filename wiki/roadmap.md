...
| L1  | P1       | IN_PROGRESS | design+docs | B8,B9      | Local-first UX/design audit for web + mobile (auth, contacts, labels, trash, errors/loading/empty states).                    | Checklist of prioritized UX gaps with acceptance criteria for local stack (`pnpm env:supabase:local`).                                                                                                                                                                          |
| L2  | P1       | TODO   | code             | L1         | Implement highest-priority local UX fixes (web + mobile parity where applicable).                                               | Local manual pass confirms improved flow quality for selected fixes.                                                                                                                                                                                                              |
