...
| R15 | P1       | TODO         | code+design | R5         | Rewrite to use Tailwind + shadcn patterns where applicable (web-first).                                                                                                                                                                                                                                                                                                                    | Not complete: web still depends on centralized inline-style tokens in `ui-styles.ts`; full Tailwind/shadcn component migration remains pending.                                                                                                                                                                                                                                                                                                                                                                                                                 |
